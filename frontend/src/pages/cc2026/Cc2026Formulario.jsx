      ...
      <div className="form-box">
        <form onSubmit={handleSubmit}>
          <label>
            ...
            <input name="radicacion" value={form.radicacion} onChange={handleChange}
          ...
          <label>
            Ponente
            <input name="ponente" value={form.ponente || ''} onChange={handleChange} />
          </label>
          <label>
            Norma demandada
            <textarea name="normaDemandada" value={form.normaDemandada || ''} onChange={handleChange} />
          </label>
          <label>
            Demandante
            <input name="demandante" value={form.demandante || ''} onChange={handleChange} />
          </label>
          <label>
            Fecha
          ...
          <label>
            URL proceso
            <input name="urlProceso" value={form.urlProceso || ''} onChange={handleChange} />
          </label>
          <label>
            URL demanda
            <input name="urlDemanda" value={form.urlDemanda || ''} onChange={handleChange} />
          </label>
          ...
          <div className="form-actions">
            ...
            <button type="button" className="btn btn-secundario" onClick={() => navigate('/cc2026')}>
              Cancelar
            </button>
          </div>
        </form>
